...
import { townshipColumns, townshipPayload } from "../township.payload";
...
import { setPaginate } from "../township.slice";
...
const TownshipTableView = () => {
  ...
  const { data, pagingParams } = useSelector(
    (state: AppRootState) => state.township
  );
  ...
  const loadingData = React.useCallback(async () => {
    setLoading(true);
    await townshipService.index(dispatch, pagingParams);
    setLoading(false);
...
export default TownshipTableView;
