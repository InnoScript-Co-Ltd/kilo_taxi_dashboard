...
import ReasonDeletedList from "./view/ReasonDeletedList";
...
export const ReasonRoute = [
  ...
  {
    id: "reason-deletedList",
    path: paths.reasonDeletedList, // Ensure this is defined in your paths constant
    element: <ReasonDeletedList />, // This is where your reason table or list component will be rendered
    loader: () => {
      return {
        breadcrumbs: [
          { label: "Dashboard", url: paths.dashboard },
          { label: "Reason", url: paths.reasonDeletedList },
        ],
      };
    },
  },
