...
export const driverColumns: readonly DriverColumn[] = [
  ...
  { id: "profile", label: "Profile", minWidth: 50, numeric: false, disablePadding: false, sort: true },
  { id: "mobilePrefix", label: "Mobile Prefix", minWidth: 35, numeric: false, disablePadding: false, sort: true },
  { id: "phone", label: "Phone", minWidth: 70, numeric: false, disablePadding: false, sort: true },
  { id: "email", label: "Email", minWidth: 100, numeric: false, disablePadding: false, sort: true },
  { id: "dob", label: "DOB", minWidth: 135, numeric: false, disablePadding: false, sort: true },
  { id: "nrc", label: "NRC", minWidth: 70, numeric: false, disablePadding: false, sort: true },
  { id: "driverLicense", label: "Driver License", minWidth: 70, numeric: false, disablePadding: false, sort: true },
  { id: "address", label: "Address", minWidth: 145, numeric: false, disablePadding: false, sort: true },
  { id: "state", label: "State", minWidth: 70, numeric: false, disablePadding: false, sort: true },
  { id: "city", label: "City", minWidth: 70, numeric: false, disablePadding: false, sort: true },
  { id: "townShip", label: "TownShip", minWidth: 70, numeric: false, disablePadding: false, sort: true },
  { id: "gender", label: "Gender", minWidth: 50, numeric: false, disablePadding: false, sort: true },
  { id: "status", label: "Status", minWidth: 50, numeric: false, disablePadding: false, sort: true },
  { id: "kycStatus", label: "Kyc Status", minWidth: 50, numeric: false, disablePadding: false, sort: false },
