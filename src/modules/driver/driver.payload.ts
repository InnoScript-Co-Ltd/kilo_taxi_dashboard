...
export const driverSchema = z.object({
  ...
  driverImageLicenseFront: z
    .string()
    .url({ message: "Driver License Front must be a valid URL" }),
  driverImageLicenseBack: z
    .string()
    .url({ message: "Driver License Back must be a valid URL" }),
