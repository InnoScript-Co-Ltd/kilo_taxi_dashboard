        ...
        <div>
          ...
          >
            ...
            <AccordionDetails key={driver.id}>
              ...
              <p>
                <strong>Profile:</strong> {driver.profile}
              </p>
              <p>
              ...
              <p>
                <strong>DOB:</strong> {driver.dob}
              </p>
              <p>
                <strong>NRC:</strong> {driver.nrc}
              </p>
              <p>
                <strong>NRC Image Front:</strong> {driver.nrcImageFront}
              </p>
              <p>
                <strong>NRC Image Back:</strong> {driver.nrcImageBack}
              </p>
              <p>
              ...
              <p>
                ...
                {driver.driverImageLicenseFront}
              </p>
              <p>
                <strong>Driver Image License Back:</strong>{" "}
                {driver.driverImageLicenseBack}
              </p>
              <p>
                <strong>Email Verified At:</strong> {driver.emailVerifiedAt}
              </p>
              <p>
                <strong>Phone Verified At:</strong> {driver.phoneVerifiedAt}
              </p>
              <p>
          ...
          >
            ...
            {driver.wallet?.map((wallet: any) => (
              <AccordionDetails>
                ...
                <p>
                  <strong>Created Date:</strong> {wallet.createdDate}
                </p>
                <p>
                  <strong>Update Date:</strong> {wallet.updateDate}
                </p>
              </AccordionDetails>
            ))}
          </Accordion> */}
