...
import { genderStatuslists, kycStatusLists, statusOptions } from "../../../constants/config";
  ...
  return (
    <Box>
      ...
      >
        ...
        <Button
          variant="outlined"
          onClick={() => driver && navigate(`${paths.driver}/${'update'}/${driver.id}`)}
        >
          Update
        </Button>
        ...
        <div>
          ...
          onChange={(event,isExpanded)=>handleChange(isExpanded,'panel1')}>
            ...
            <AccordionDetails>
              ...
              <p><strong>Profile:</strong> <img src={driver.profile} /> </p>
              <p><strong>Mobile:</strong> {driver.mobilePrefix}{driver.phone}</p>
              <p><strong>Email:</strong> {driver.email}</p>
              <p><strong>DOB:</strong> {driver.dob ? formatDate(driver.dob.toString()) : 'N/A'}</p>
              <p><strong>NRC:</strong> {driver.nrc}</p>
              <p><strong>NRC Image Front:</strong> <img src={driver.nrcImageFront} /> </p>
              <p><strong>NRC Image Back:</strong> <img src={driver.nrcImageBack} /> </p>
              <p><strong>Driver License:</strong> {driver.driverLicense}</p>
              <p><strong>Driver Image License Front:</strong> <img src={driver.driverImageLicenseFront} /> </p>
              <p><strong>Driver Image License Back:</strong> <img src={driver.driverImageLicenseBack} /> </p>
              <p><strong>Email Verified At:</strong> {formatDate(driver.emailVerifiedAt)}</p>
              <p><strong>Phone Verified At:</strong> {formatDate(driver.phoneVerifiedAt)}</p>
          ...
          onChange={(event,isExpanded)=>handleChange(isExpanded,'panel2')}>
            ...
            <p><strong>Business License Image:</strong> <TAvatar src={vehicle.businessLicenseImage} /> </p>
            <p><strong>Vehicle License Front:</strong> <TAvatar src={vehicle.vehicleLicenseFront} /> </p>
            <p><strong>Vehicle License Back:</strong> <TAvatar src={vehicle.vehicleLicenseBack} /> </p>
            <p><strong>Status:</strong> <Status status={vehicle.status} lists={statusOptions} /> </p>
            </AccordionDetails>
))}
          </Accordion>
          ...
          onChange={(event,isExpanded)=>handleChange(isExpanded,'panel3')}>
            ...
            <p><strong>Created Date:</strong> {formatDate(wallet.createdDate)}</p>
            <p><strong>Update Date:</strong> {formatDate(wallet.updateDate)}</p>
            </AccordionDetails>
))}
          </Accordion>
