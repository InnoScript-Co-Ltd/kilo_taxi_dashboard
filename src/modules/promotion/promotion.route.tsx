...
import PromotionDeletedList from "./view/PromotionDeletedList";
export const PromotionRoute = [
  ...
  {
    id: "promotion-deletedList",
    path: paths.promotionDeletedList, // Ensure this is defined in your paths constant
    element: <PromotionDeletedList />,
    loader: () => {
      return {
        breadcrumbs: [
          { label: "Dashboard", url: paths.dashboard },
          { label: "Promotion", url: paths.promotionDeletedList },
        ],
      };
    },
  },
