...
const TravelRateTableView = () => {
  ...
  const loadingData = React.useCallback(async () => {
    setLoading(true);
    await travelRateService.index(dispatch, pagingParams, notifications);
    setLoading(false);
      ...
      >
        ...
        >
          <Button
            ...
            onClick={() => navigate(paths.travelRateCreate)}
          >
            Create
          </Button>
          ...
          <Button
            onClick={() => {
              dispatch(setPaginate(travelRatePayload.pagingParams));
              setPage(0);
              setRowsPerPage(10);
            }}
